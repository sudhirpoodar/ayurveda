 ...
 */
?>
<header class="tt-header tt-header-type-6 <?php echo magplus_get_opt('header-template-menu-icon-pos'); ?> tt-header-style-link <?php echo magplus_get_opt('page-layout'); ?>">
