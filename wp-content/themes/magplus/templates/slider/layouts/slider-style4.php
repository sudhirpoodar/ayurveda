...
<div class="container tt-mag-slider"<?php echo wp_kses_data($slider_style); ?>>
  <div class="row">
    <div class="col-md-12">
      <div class="slider-style4 tt-slider-custom-marg full-width">
