...
<!-- <div class="container"> -->
  <div class="arrow-closest tt-mag-slider tt-slider-custom-marg pt-0 mobile-show-pagination slider-style14 slider-style21 no-border"<?php echo wp_kses_data($slider_style); ?>>
    <div class="swiper-container tt-slider-type-5" data-mode="horizontal" data-effect="slide" data-slides-per-view="responsive" data-add-slides="3" data-lg-slides="3" data-md-slides="3" data-sm-slides="1" data-xs-slides="1" data-autoplay="<?php echo magplus_get_opt('slider-autoplay'); ?>" data-loop="<?php echo magplus_get_opt('slider-loop-switch'); ?>" data-speed="<?php echo magplus_get_opt('slider-speed'); ?>">
        ...
        <div class="swiper-slide wh-33">
          <div class="tt-item-post-block tt-wh-25-custom type-2 tt-item-post-border custom-hover-image">
            ...
            <div class="tt-item-post-title"<?php echo wp_kses_post($gradient_style); ?>>
              ...
              ?>
              <h4 class="c-h4"><a href="<?php echo esc_url(get_the_permalink()); ?>" class="tt-post-title"><?php the_title(); ?></a></h4>
            </div>
