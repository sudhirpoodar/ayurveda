...
<div class="tt-slider-wide tt-mag-slider tt-slider-custom-marg tt-custom-arrows"<?php echo wp_kses_data($slider_style); ?>>
  <div class="container">
    <div class="tt-slider-entry">
      <div class="swiper-container" data-autoplay="<?php echo magplus_get_opt('slider-autoplay'); ?>" data-loop="<?php echo magplus_get_opt('slider-loop-switch'); ?>" data-speed="<?php echo magplus_get_opt('slider-speed'); ?>" data-center="1" data-slides-per-view="responsive" data-xs-slides="3" data-sm-slides="2" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
        <div class="swiper-wrapper<?php echo (!magplus_get_opt('slider-swipe-switch')) ? ' swipe-disabled':''; ?> clearfix">
          ...
          <div class="swiper-slide slider-style7 <?php echo ($i === 0) ? 'active':''; ?>" data-val="<?php echo esc_attr($i); ?>">
            <div class="tt-slide-2 custom-hover-image">
              ...
              <div class="tt-slide-2-info">
                <div class="tt-slide-2-cat">
                  <?php 
                ...
                <h1 class="tt-slide-2-title c-h1"><?php the_title(); ?></h1>
