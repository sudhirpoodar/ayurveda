...
<div class="container">
  <div class="arrow-closest tt-mag-slider tt-slider-custom-marg pt-10 mobile-show-pagination slider-style26 slider-style14"<?php echo wp_kses_data($slider_style); ?>>
