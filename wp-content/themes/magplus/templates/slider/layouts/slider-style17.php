...
<div class="container">
  <div class="arrow-closest tt-mag-slider tt-slider-custom-marg mobile-show-pagination pt-10 slider-style17"<?php echo wp_kses_data($slider_style); ?>>
    <div class="swiper-container tt-slider-type-5" data-mode="horizontal" data-effect="slide" data-slides-per-view="1" data-sm-slides="1" data-xs-slides="1" data-autoplay="<?php echo magplus_get_opt('slider-autoplay'); ?>" data-loop="<?php echo magplus_get_opt('slider-loop-switch'); ?>" data-speed="<?php echo magplus_get_opt('slider-speed'); ?>">
      <div class="swiper-wrapper<?php echo (!magplus_get_opt('slider-swipe-switch')) ? ' swipe-disabled':''; ?>">

        <?php 
          $i = 1; 
          if ( $the_query->have_posts() ) : while ( $the_query->have_posts() ) : $the_query->the_post();
          $count = 1; if($i % 5 == 2) { $count = 2; } elseif($i % 5 == 3) { $count = 3;} elseif($i % 5 == 4) {$count = 4;} elseif($i % 5 == 0) {$count = 5;}
          ...
          <?php if($count < 3 && $count != 2):?><div class="tt-item-wh-25-wrap"><?php endif; ?>
          ...
          <div class="tt-slide-item item-<?php echo esc_attr( $count ); ?>">
            <div class="tt-item-post-block type-2 tt-item-post-border custom-hover-image">
              ...
              <div class="tt-item-post-title">
                ...
                ?>
                <h4 class="<?php echo ($count == 3) ? 'tt-h2-title':'tt-h4-title'; ?>"><a href="<?php echo esc_url(get_the_permalink()); ?>" class="tt-post-title"><?php the_title(); ?></a></h4>
                <?php if($count == 3): ?>
          ...
          <?php if($count < 3 && $count == 2):?></div><?php endif; ?>
          <?php if( ($i % 5 == 0) && ($i < $posts_per_page) ): ?></div><div class="swiper-slide"><?php endif; ?>
