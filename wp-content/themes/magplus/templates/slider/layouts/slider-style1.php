...
<!-- TT-SLIDER-WIDE -->
<div class="tt-slider-wide tt-mag-slider tt-slider-custom-marg slider-style1 tt-custom-arrows"<?php echo wp_kses_data($slider_style); ?>>
  <div class="container">
    <div class="tt-slider-entry">
      <div class="tt-swiper-margin-10">
        <div class="swiper-container" data-autoplay="<?php echo magplus_get_opt('slider-autoplay'); ?>" data-loop="<?php echo magplus_get_opt('slider-loop-switch'); ?>" data-speed="<?php echo magplus_get_opt('slider-speed'); ?>" data-center="1" data-slides-per-view="responsive" data-xs-slides="3" data-sm-slides="3" data-md-slides="3" data-lg-slides="3" data-add-slides="3">
          <div class="swiper-wrapper<?php echo (!magplus_get_opt('slider-swipe-switch')) ? ' swipe-disabled':''; ?> clearfix">
            ...
            <div class="swiper-slide <?php echo ($i === 0) ? 'active':''; ?>" data-val="<?php echo esc_attr($i); ?>">
              <div class="tt-swiper-margin-10-entry">
                <div class="tt-mslide type-2 custom-hover-image">


                  <div class="tt-mslide-image bg tt-mslide type-2" style="background-image:url(<?php echo esc_url($image_src); ?>);">
  ...
  <div class="custom-arrow-right c-arrow <?php echo (!magplus_get_opt('slider-show-pagination-switch')) ? 'hidden-lg':''; ?> right size-2 pos-1 hidden-xs hidden-sm">
