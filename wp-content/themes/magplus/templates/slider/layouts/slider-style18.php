...
<?php
  ...
  $editor_categories = magplus_get_opt('slider-editor-pick-category');
              ...
              <?php if($editor_query->have_posts()): ?>
                <div class="row hidden-xs">
                  <div class="col-sm-4 col-sm-offset-8">
                    <div class="pleft30 slider-style2-post-grid">
                      <div class="tt-title-block light">
                        <h3 class="tt-title-text"><?php esc_html_e('Editors Picks', 'magplus'); ?></h3>
                      </div>
