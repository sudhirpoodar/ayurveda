...
<div class="slider-style5 slider-style23 tt-mag-slider tt-slider-custom-marg"<?php echo wp_kses_data($slider_style); ?>>
    ...
    <!-- <div class="col-lg-8"> -->
      ...
      <div class="slider-style5-frame">
        ...
        <div class="tt-mslide type-2 long style-2 custom-hover-image">
          <div class="tt-mslide-image tt-mslide bg" style="background-image:url(<?php echo esc_url($image_src); ?>);">
