...
<div class="tt-blog-head background-block <?php echo ($parallax) ? 'tt-parallax-on':''; ?>"<?php echo wp_kses_post($image_style); ?>>
...
<div class="container">
  ...
  <div class="empty-space marg-lg-b35 marg-sm-b30"></div>
    ...
    <?php 
      if($post_format == 'audio' || $post_format == 'video' || $post_format == 'quote'):
        get_template_part('templates/blog/blog-single/parts/single', 'media'); 
