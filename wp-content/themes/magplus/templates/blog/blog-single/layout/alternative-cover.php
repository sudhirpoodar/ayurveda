...
<div class="tt-alternative-cover-style">
  ...
  <div class="tt-video-post-wrapper alternative-cover">
    <div class="container">
      <div class="row">
  ...
  <div class="tt-blog-head alternative-cover <?php echo ($parallax) ? 'tt-parallax-on':''; ?> background-block tt-alternative-title-middle"<?php echo wp_kses_post($image_style); ?>>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2">                    
            ...
            <h1 class="c-h1 text-left"><?php the_title(); ?></h1>
