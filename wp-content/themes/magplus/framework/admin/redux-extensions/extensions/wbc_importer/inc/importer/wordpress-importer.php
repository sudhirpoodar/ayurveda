...
<?php
  ...
  function process_menu_item( $item ) {
    ...
    $custom_fields = array(
      '_menu_item_megamenu',
      '_menu_item_megamenu_page',
      '_menu_item_font_icon',
      '_menu_item_label_custom',
      '_menu_item_label_color'
    );
      
    if ( $id && ! is_wp_error( $id ) ) {
      foreach( $item['postmeta'] as $index => $meta ) {
          if( in_array( $meta['key'], $custom_fields ) ) {
