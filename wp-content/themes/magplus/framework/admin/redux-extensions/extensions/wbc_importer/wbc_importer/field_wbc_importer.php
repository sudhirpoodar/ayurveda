    ...
    class ReduxFramework_wbc_importer {
        ...
        function __construct( $field = array(), $value ='', $parent ) {
            ...
            if ( empty( $this->extension_dir ) ) {
                ...
                //$this->extension_url = get_template_directory_uri().'/framework/admin/;
            }
        }
        ...
        public function render() {
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    if($imported == true) {
                      echo '<div id="wbc-importer-reimport" class="wbc-importer-buttons more-details button-primary import-demo-data importer-button">'.esc_html__( 'Re-Import', 'framework' ).'</div>';
                    }
